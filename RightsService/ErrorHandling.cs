...
namespace RightsService
{
    ...
    {
        public ErrorHandling(RequestDelegate next, MiddlewareOptions options = null) : base(next, options)
        {
        }
        ...
        protected override async Task OnError(HttpContext context, Exception ex)
        {
            ...
            await context.Response.WriteAsync(JsonConvert.SerializeObject(new { errorMessage = ex.ToString() }));
